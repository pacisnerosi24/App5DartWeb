...
(function dartProgram() {
  ...
  A = {JS_CONST: function JS_CONST() {
    ...
    main() {
      var t3,
        ...
        sumarButton = t2._as(t1.querySelector("#sumar")),
        restarButton = t2._as(t1.querySelector("#restar"));
      t2 = type$.InputElement;
      t1 = new A.main_calcular(t2._as(t1.querySelector("#num1")), t2._as(t1.querySelector("#num2")), type$.HeadingElement._as(t1.querySelector("#resultado")));
      t2 = type$._ElementEventStreamImpl_MouseEvent;
      t3 = t2._eval$1("~(1)?");
      t2 = t2._precomputed1;
      A._EventStreamSubscription$(sumarButton, "click", t3._as(new A.main_closure(t1)), false, t2);
      A._EventStreamSubscription$(restarButton, "click", t3._as(new A.main_closure0(t1)), false, t2);
    },
    main_calcular: function main_calcular(t0, t1, t2) {
      this.num1Input = t0;
      this.num2Input = t1;
      this.resultado = t2;
    },
  ...
  A.main_calcular.prototype = {
    call$1(operacion) {
      var num1, num2, res,
        t1 = this.num1Input.value;
      t1.toString;
      num1 = A.double_parse(t1);
      t1 = this.num2Input.value;
      t1.toString;
      num2 = A.double_parse(t1);
      res = operacion === "sumar" ? num1 + num2 : num1 - num2;
      B.HeadingElement_methods.set$text(this.resultado, "El resultado es: " + A.S(res));
    },
    $signature: 11
  };
  A.main_closure.prototype = {
    call$1($event) {
      ...
      return this.calcular.call$1("sumar");
    },
    $signature: 3
  };
  A.main_closure0.prototype = {
    call$1($event) {
      type$.MouseEvent._as($event);
      return this.calcular.call$1("restar");
    },
    $signature: 3
  };
  (function aliases() {
  ...
  (function inheritance() {
    ...
    _inheritMany(A.Object, [A.JS_CONST, J.Interceptor, J.ArrayIterator, A.Error, A.TypeErrorDecoder, A.NullThrownFromJavaScriptException, A._StackTrace, A.Closure, A.Rti, A._FunctionParameters, A._Type, A._TimerImpl, A.AsyncError, A._FutureListener, A._Future, A._AsyncCallbackEntry, A.Stream, A._Zone, A.StackOverflowError, A._Exception, A.FormatException, A.Null, A._StringStackTrace, A.StringBuffer, A.EventStreamProvider, A._EventStreamSubscription]);
    ...
    _inheritMany(A.Closure, [A.Closure0Args, A.Closure2Args, A.TearOffClosure, A.initHooks_closure, A.initHooks_closure1, A._AsyncRun__initializeScheduleImmediate_internalCallback, A._AsyncRun__initializeScheduleImmediate_closure, A._Future__propagateToListeners_handleWhenCompleteCallback_closure, A.Stream_length_closure, A._RootZone_bindUnaryCallbackGuarded_closure, A._EventStreamSubscription_closure, A.main_calcular, A.main_closure, A.main_closure0]);
